...
const workflow = [
  ...
  },
  {
    ...
    summary:
      "A Limited Scope Review of a CIM in minutes: a Business Quality Assessment, an honest ethic rating, a per-deal valuation, and DSCR / SBA financing fit."
  },
  {
    step: "03",
      ...
      <section className="hero section">
        <div className="hero__content">
          ...
          <p className="hero__lead">
            Screen opportunities, run a Limited Scope Review, run a CPA-signed Quality of
            Earnings, and track every deal to close. Multi-asset research and acquisition
            intelligence, built for independent investors and acquirers.
          </p>
